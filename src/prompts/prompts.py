...
check_eligibility_prompt = _load_prompt("check_eligibility_prompt.txt")
explain_criteria_prompt = _load_prompt("explain_criteria_prompt.txt")
compare_trials_prompt = _load_prompt("compare_trials_prompt.txt")
translate_terms_prompt = _load_prompt("translate_terms_prompt.txt")
